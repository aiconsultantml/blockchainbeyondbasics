...
web3.eth.getTransactionCount(fromAccount, (err, txCount) => {
  ...
  // Trigger the depositCrypto() Transferring 0.02 ether in the value section
  // The data field will be a call to this method. 
  const transactionObject = {
    nonce: web3.utils.toHex(txCount),
    to: contractAddr,
    value: web3.utils.toHex(web3.utils.toWei('0.02', 'ether')),
    gasLimit: web3.utils.toHex(126000),
    gasPrice: web3.utils.toHex(web3.utils.toWei('10', 'gwei')),
    data: contractHandler.methods.depositCrypto().encodeABI()
  }
